...
export const CloudUpload = ({ setImage, image }: CloudUploadProps) => {
    ...
    <div className="flex flex-col gap-1.5 relative max-h-57">
      ...
      >
        {({ open }) => {
          return (
            ...
            >
              <span className="z-[-1] text-[13px] text-gray-500 font-medium absolute bottom-[30%] left-[25%]">
      ...
      {image && (
        <img
          src={image}
          alt="Uploaded food"
          className="rounded-xl w-full max-h-55 z-100 object-cover"
        />
      )}
    </div>
  );
